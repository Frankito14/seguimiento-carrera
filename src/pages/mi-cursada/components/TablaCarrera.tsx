            ...
            <div className="mt-4 w-full p-4 bg-white rounded shadow-md text-neutral-600 border-1 border-neutral-300 relative">
                <div className="p-2 text-md space-y-2 mb-4 font-semibold sticky">
                    <div className="flex  justify-between gap-4 justify-items-center flex-wrap ">
                        ...
                        <div className="flex flex-wrap justify-end gap-2 justify-items-center ">
                            <button onClick={() => mostrarMateriasRecomendadas()}
                                title="Materias recomendadas"
                                className="px-3 py-3 hover:cursor-pointer text-xl font-bold text-white uppercase transition-all duration-150 bg-emerald-600 rounded shadow outline-none active:bg-teal-600 hover:bg-teal-700 focus:outline-none ease">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6" viewBox="0 0 24 24"><path fill="#ffffff" d="m22 10l-.625-1.375L20 8l1.375-.625L22 6l.625 1.375L24 8l-1.375.625L22 10Zm-3-4l-.95-2.05L16 3l2.05-.95L19 0l.95 2.05L22 3l-2.05.95L19 6ZM9 22q-.825 0-1.413-.588T7 20h4q0 .825-.588 1.413T9 22Zm-4-3v-2h8v2H5Zm.25-3q-1.725-1.025-2.738-2.75T1.5 9.5q0-3.125 2.188-5.313T9 2q3.125 0 5.313 2.188T16.5 9.5q0 2.025-1.012 3.75T12.75 16h-7.5Zm.6-2h6.3q1.125-.8 1.738-1.975T14.5 9.5q0-2.3-1.6-3.9T9 4Q6.7 4 5.1 5.6T3.5 9.5q0 1.35.612 2.525T5.85 14ZM9 14Z" /></svg>
                            </button>
                            <button onClick={() => reiniciarCursada()}
                                title="Reiniciar cursada"
                                className="px-3 py-3 hover:cursor-pointer text-xl font-bold text-white uppercase transition-all duration-150 bg-rose-900 rounded shadow outline-none  hover:bg-rose-800 focus:outline-none ease">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6" viewBox="0 0 24 24"><path fill="#ffffff" d="M12 4c2.1 0 4.1.8 5.6 2.3c3.1 3.1 3.1 8.2 0 11.3c-1.8 1.9-4.3 2.6-6.7 2.3l.5-2c1.7.2 3.5-.4 4.8-1.7c2.3-2.3 2.3-6.1 0-8.5C15.1 6.6 13.5 6 12 6v4.6l-5-5l5-5zM6.3 17.6C3.7 15 3.3 11 5.1 7.9l1.5 1.5c-1.1 2.2-.7 5 1.2 6.8q.75.75 1.8 1.2l-.6 2q-1.5-.6-2.7-1.8" /></svg>
                            </button>
                        </div>
                    </div>
                    ...
                    <p id="inicio">Porcentaje de aprobación: <span className="text-emerald-700 font-bold">{porcentajeAprobacion}%</span></p>
                </div>
            </div>
